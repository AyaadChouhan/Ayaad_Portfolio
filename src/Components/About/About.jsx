                    ...
                    <FadeInDiv
                        element={
                            <p className='text-lg sm:text-xl text-[#CFCFCF]'>
                                I’m Ayaad Chouhan, Software Engineer from Jodhpur, Rajasthan. I have over two years of experience building web applications that are both scalable and user-friendly. I completed my BCA in Computer Science fromUniversity College of Engineering and Technology ,Jodhpur. I work with technologies like React.js, Node.js, MongoDB, and PostgreSQL, and I enjoy creating seamless frontends and efficient backends.
                            </p>
                        }
                        delay={.4}
                    />
