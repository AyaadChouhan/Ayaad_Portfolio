...
const About = () => {
  ...
  return (
    <div
      ref={ref}
      id="about"
      className="min-h-screen flex px-2 sm:px-6 xl:px-12 pt-20 pb-32 justify-center relative"
    >
      <div className="max-w-[1000px] items-center flex flex-col lg:flex-row gap-10">
        <div className=" w-[95%] md:w-[80%] lg:self-start lg:w-[50%] flex flex-col gap-3 sm:gap-5">
          ...
          <FadeInDiv
            element={
              <p className="text-lg sm:text-xl text-[#CFCFCF]">
                I’m Ayaad Chouhan, Software Engineer from Jodhpur, Rajasthan. I
                have over two years of experience building web applications that
                are both scalable and user-friendly. I completed my BCA in
                Computer Science fromUniversity College of Engineering and
                Technology ,Jodhpur. I work with technologies like React.js,
                Node.js, MongoDB, and PostgreSQL, and I enjoy creating seamless
          ...
          <FadeInDiv
            element={
              <p className="text-lg sm:text-xl text-[#CFCFCF]">
                In my spare time, I enjoy watching movies, exploring new TV
                shows, and diving into different corners of the internet. I’ve
                always infused a personal touch of my hobbies into most of my
                projects and I’m always keen on discovering new projects or
                ideas, so feel free to get in touch!
              </p>
            }
            delay={0.4}
          />
